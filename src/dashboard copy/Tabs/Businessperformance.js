...
const Businessperformance = ({}) => {
  ...
  var TotalFeesCollected = nf.format(
  ...
  const totalProjectedCollections = nf.format(
                    ...
                    >
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            BNPL - <span className="Rm-text">RM</span>
                            {/* {Businessperformance.bnplInterestAndFeesCollected} */}
                        ...
                        <tr>
                          {/* <th scope="row"></th> */}
                          <td className="QhFeesCollected">
                            QH - <span className="Rm-text">RM</span>
                            {/* {Businessperformance.qardHasanInterestAndFeesCollected} */}
                            {QHinterestCollected}
                          </td>
                        </tr>
