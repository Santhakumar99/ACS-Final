...
const SearchData = () => {
    ...
    try {
      ...
      if (Result && Result.data) {
        ...
        for (let i = 0; i < array.length; i++) {
          ...
          element.SearchData = {
            "Borrower Name":
              (element.userId != null && element.userId.firstName) +
              "" +
              (element.userId != null && element.userId.lastName),
            "Loan ID": element._id,
            "Product Name": element.productType,
            "IC Number": element.userId != null && element.userId.icNumber,
            "Loan Amount (RM)": element.loanAmount,
            Tenure: element.tenure,
            Phone: element.userId != null && element.userId.mobile,
            "Loan Status": element.loanStatus,
          };
  ...
  const downloadExcel = () => {
    ...
    //   Loans != null &&
    //   Loans.length > 0 &&
    //   Loans.SearchData != null &&
    //   Loans.map((s) => s.SearchData);
    // console.log(Loans);
    const Data = Loans != null && Loans.map((s) => s.SearchData);
    const newData =
      Data != null &&
      Data.map((row) => {
          ...
          <div className="search-head">
            ...
            <div className="Search-head">
              <form onSubmit={onSubmit}>
                <div className="row one" style={{ marginBottom: "10px" }}>
                ...
                <div className="row two" style={{ marginBottom: "10px" }}>
                  ...
                  <div className="col-lg-3 col-md-3 col-sm-12 search-field lt">
                ...
                <div className="row three" style={{ marginBottom: "10px" }}>
                  <div className="col-lg-3 col-md-3 col-sm-12 search-field">
                    <FormControl fullWidth>
                      <InputLabel id="demo-simple-select-helper-label">
                        Acs score
                  ...
                  <div className="col-lg-3 col-md-3 col-sm-12 search-field">
                    <FormControl fullWidth>
                      ...
                      >
                        ...
                        <MenuItem value={"Quad Hasan"}>Qard Hasan</MenuItem>
                      </Select>
                    </FormControl>
                  </div>
                  <div className="col-lg-3 col-md-3 col-sm-12 search-field">
                ...
                <div className="row four" style={{ marginBottom: "10px" }}>
                  <div className="col-lg-3 col-md-3 col-sm-12 search-field">
                    <FormControl fullWidth>
                      <InputLabel id="demo-simple-select-helper-label">
                        Over Due
